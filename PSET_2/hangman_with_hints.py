...
def match_with_gaps(my_word, other_word):
    ...
    #print("Lengths of my_word: ", len(my_word), "\nLength of other_word: ", len(other_word))
    #print(my_word)
    counter = 0
    ...
    if len(my_word) == len(other_word):
      #print("hi")
      for a in other_word:
        #print("A: ", a, "counter: ", my_word[counter])
        if not a == my_word[counter] and not my_word[counter] == '_':
          return False
        #print("A: ", a, "counter: ", my_word[counter])
        counter +=1
    else:
    ...
    return True
    #You are on the part where you have to find out how to strip spaces
    # FILL IN YOUR CODE HERE AND DELETE "pass"

'''
Test for match_with_gaps function
...
'''
Test for show_possible_matches function
